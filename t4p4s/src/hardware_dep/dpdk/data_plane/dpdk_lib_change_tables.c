...
*/
void exact_flush_promote(int tableid, bool should_print) {
    FORALLNUMANODES(Delete, "/" T4LIT(exact), CHANGE_TABLE(exact_flush,NULL), should_print)
}
void lpm_flush_promote(int tableid, bool should_print) {
    FORALLNUMANODES(Delete, "/" T4LIT(LPM), CHANGE_TABLE(lpm_flush,NULL), should_print)
}
/*void ternary_flush_promote(int tableid, bool should_print) {
    FORALLNUMANODES(Delete, "/" T4LIT(ternary), CHANGE_TABLE(ternary_flush,NULL), should_print)
}*/
////////////////////////////////////Xiajiqiang 2020/09/22////////////////////////////////////////////////
