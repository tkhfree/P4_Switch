...
struct p4_remove_table_entry {
	struct p4_header header;
	char table_name[P4_MAX_TABLE_NAME_LEN];
	uint8_t read_size;
};

struct p4_get_table_entries {
	struct p4_header header;
	char table_name[P4_MAX_TABLE_NAME_LEN];
	uint8_t read_size;
	//struct p4_field_match matches[read_size]; 
...
struct p4_remove_table_entry* netconv_p4_remove_table_entry(struct p4_remove_table_entry* m);
struct p4_get_table_entries* netconv_p4_get_table_entries(struct p4_get_table_entries* m);
